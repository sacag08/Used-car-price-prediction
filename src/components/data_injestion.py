...
class DataInjestion:
    ...
    def initiate_data_injestion(self):
        ...
        try:
            ...
            data.to_csv(DataIngestionConfig.train_data_path)
            ...
            train_data.to_csv(DataIngestionConfig.train_data_path)
            test_data.to_csv(DataIngestionConfig.test_data_path)
            raw_data.to_csv(DataIngestionConfig.raw_data_path)
